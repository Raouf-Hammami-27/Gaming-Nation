...
@Embeddable
public class ParticipantTournamentPK implements Serializable {
	private String idParticipant;
	private int idEvent;
	
	
	public ParticipantTournamentPK() {
		super();
	}
	public ParticipantTournamentPK(String idParticipant, int idEvent) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ParticipantTournamentPK other = (ParticipantTournamentPK) obj;
